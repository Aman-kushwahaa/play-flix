...
const PlayVideo = () => {
  ...
  const fetchOtherData = async () => {
    ...
    const channel_data_url = `https://youtube.googleapis.com/youtube/v3/channelSections?part=snippet%2CcontentDetails&channelId=${apiData.snippet.channelId}&key=${API_KEY}`;
          ...
          return (
            <div key={index} className="comment">
              ...
              <div>
                ...
                <p>{item.snippet.topLevelComment.snippet.texDisplay}</p>
